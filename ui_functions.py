...
class UIFunctions(MainWindow):
    ...
    def selectMenu(getStyle):
        select = getStyle + ("QPushButton { border-right: 7px solid rgb(44, 49, 60); border-color: rgb(44, 49, 60);background-color: rgb(44, 49, 60);}")
        return select

    def deselectMenu(getStyle):
        deselect = getStyle.replace("QPushButton { border-right: 7px solid rgb(44, 49, 60); border-color: rgb(44, 49, 60);background-color: rgb(44, 49, 60);}", "")
        return deselect
