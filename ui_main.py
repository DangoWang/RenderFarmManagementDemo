...
from thirdparty import dayu_widgets
...
"}")
        ...
        self.frame_icon_top_bar.setStyleSheet(f"background: transparent;background-image: url({os.environ['ROOTPATH']}"
                                              f"/icons/custom/oort_logo.png);background-position: center;"
...
"}")
        ...
        # self.label_top_info_1.setMaximumSize(QSize(16777215, 200))
        font2 = QFont()
        ...
        self.horizontalLayout_8.addItem(QSpacerItem(0, 0, QSizePolicy.Expanding, QSizePolicy.Minimum))

        # self.commandLinkButton = QCommandLinkButton()
        # self.commandLinkButton.setObjectName(u"wechat_check")
        # self.commandLinkButton.setText(u'微信扫一扫，监控进度')
        ...
        #                                      "}")
        # icon4 = QIcon()
        # icon4.addFile(f'{os.environ["ROOTPATH"]}/icons/custom/wechat.svg', QSize(), QIcon.Normal, QIcon.Off)
        # self.commandLinkButton.setIcon(icon4)
        # self.horizontalLayout_8.addWidget(self.commandLinkButton)

        # self.wechat_button = dayu_widgets.MToolButton().svg(f'{os.environ["ROOTPATH"]}/icons/custom/wechat.svg')
        # self.horizontalLayout_8.addWidget(self.wechat_button)
        wechat_check_label = dayu_widgets.MToolButton().text_beside_icon()
        wechat_check_label.setText(u'微信扫一扫，监控进度')
        wechat_check_label.set_dayu_svg(f'{os.environ["ROOTPATH"]}/icons/custom/wechat.svg')
        wechat_check_label.setStyleSheet(wechat_check_label.styleSheet()+"QToolButton {color: rgb(85, 170, 255);}")
        self.horizontalLayout_8.addWidget(wechat_check_label)

        self.horizontalLayout_8.addItem(QSpacerItem(0, 0, QSizePolicy.Expanding, QSizePolicy.Minimum))
        # self.horizontalLayout_8.addWidget(self.label_top_info_2)
        self.account_toolbutton = dayu_widgets.MToolButton().svg(f'{os.environ["ROOTPATH"]}/icons/custom/account.svg')
        self.notice_toolbutton = dayu_widgets.MToolButton().svg(f'{os.environ["ROOTPATH"]}/icons/custom/notice.svg')
        self.project_setting_toolbutton = dayu_widgets.MToolButton().svg(f'{os.environ["ROOTPATH"]}/icons/custom/project_setting.svg')
        self.help_toolbutton = dayu_widgets.MToolButton().svg(f'{os.environ["ROOTPATH"]}/icons/custom/help.svg')
        self.horizontalLayout_8.addWidget(self.account_toolbutton)
        self.horizontalLayout_8.addWidget(self.notice_toolbutton)
        self.horizontalLayout_8.addWidget(self.project_setting_toolbutton)
        self.horizontalLayout_8.addWidget(self.help_toolbutton)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.label_user_icon.setText(QCoreApplication.translate("MainWindow", u"Team", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("MainWindow", u"Copyright © bytedance", None))
